...
const routes = {
  ...
  'meesho_labels.download': {
    ...
    tokens: [{"old":"/meesho/labels/download","type":0,"val":"meesho","end":""},{"old":"/meesho/labels/download","type":0,"val":"labels","end":""},{"old":"/meesho/labels/download","type":0,"val":"download","end":""}],
    types: placeholder as Registry['meesho_labels.download']['types'],
  },
  'meesho_labels.index_jobs': {
    methods: ["GET","HEAD"],
    pattern: '/meesho/labels/jobs',
    tokens: [{"old":"/meesho/labels/jobs","type":0,"val":"meesho","end":""},{"old":"/meesho/labels/jobs","type":0,"val":"labels","end":""},{"old":"/meesho/labels/jobs","type":0,"val":"jobs","end":""}],
    types: placeholder as Registry['meesho_labels.index_jobs']['types'],
  },
  'meesho_labels.show_job': {
    methods: ["GET","HEAD"],
    pattern: '/meesho/labels/jobs/:id',
    tokens: [{"old":"/meesho/labels/jobs/:id","type":0,"val":"meesho","end":""},{"old":"/meesho/labels/jobs/:id","type":0,"val":"labels","end":""},{"old":"/meesho/labels/jobs/:id","type":0,"val":"jobs","end":""},{"old":"/meesho/labels/jobs/:id","type":1,"val":"id","end":""}],
    types: placeholder as Registry['meesho_labels.show_job']['types'],
  },
  'meesho_labels.job_progress': {
    methods: ["GET","HEAD"],
    pattern: '/meesho/labels/jobs/:id/progress',
    tokens: [{"old":"/meesho/labels/jobs/:id/progress","type":0,"val":"meesho","end":""},{"old":"/meesho/labels/jobs/:id/progress","type":0,"val":"labels","end":""},{"old":"/meesho/labels/jobs/:id/progress","type":0,"val":"jobs","end":""},{"old":"/meesho/labels/jobs/:id/progress","type":1,"val":"id","end":""},{"old":"/meesho/labels/jobs/:id/progress","type":0,"val":"progress","end":""}],
    types: placeholder as Registry['meesho_labels.job_progress']['types'],
  },
  'meesho_labels.download_final_pdf': {
    methods: ["GET","HEAD"],
    pattern: '/meesho/labels/jobs/:id/download',
    tokens: [{"old":"/meesho/labels/jobs/:id/download","type":0,"val":"meesho","end":""},{"old":"/meesho/labels/jobs/:id/download","type":0,"val":"labels","end":""},{"old":"/meesho/labels/jobs/:id/download","type":0,"val":"jobs","end":""},{"old":"/meesho/labels/jobs/:id/download","type":1,"val":"id","end":""},{"old":"/meesho/labels/jobs/:id/download","type":0,"val":"download","end":""}],
    types: placeholder as Registry['meesho_labels.download_final_pdf']['types'],
  },
  'meesho_labels.list_schedules': {
    methods: ["GET","HEAD"],
    pattern: '/meesho/labels/schedules',
    tokens: [{"old":"/meesho/labels/schedules","type":0,"val":"meesho","end":""},{"old":"/meesho/labels/schedules","type":0,"val":"labels","end":""},{"old":"/meesho/labels/schedules","type":0,"val":"schedules","end":""}],
    types: placeholder as Registry['meesho_labels.list_schedules']['types'],
  },
  'meesho_labels.create_schedule': {
    methods: ["POST"],
    pattern: '/meesho/labels/schedules',
    tokens: [{"old":"/meesho/labels/schedules","type":0,"val":"meesho","end":""},{"old":"/meesho/labels/schedules","type":0,"val":"labels","end":""},{"old":"/meesho/labels/schedules","type":0,"val":"schedules","end":""}],
    types: placeholder as Registry['meesho_labels.create_schedule']['types'],
  },
  'meesho_labels.show_schedule': {
    methods: ["GET","HEAD"],
    pattern: '/meesho/labels/schedules/:id',
    tokens: [{"old":"/meesho/labels/schedules/:id","type":0,"val":"meesho","end":""},{"old":"/meesho/labels/schedules/:id","type":0,"val":"labels","end":""},{"old":"/meesho/labels/schedules/:id","type":0,"val":"schedules","end":""},{"old":"/meesho/labels/schedules/:id","type":1,"val":"id","end":""}],
    types: placeholder as Registry['meesho_labels.show_schedule']['types'],
  },
  'meesho_labels.update_schedule': {
    methods: ["PUT"],
    pattern: '/meesho/labels/schedules/:id',
    tokens: [{"old":"/meesho/labels/schedules/:id","type":0,"val":"meesho","end":""},{"old":"/meesho/labels/schedules/:id","type":0,"val":"labels","end":""},{"old":"/meesho/labels/schedules/:id","type":0,"val":"schedules","end":""},{"old":"/meesho/labels/schedules/:id","type":1,"val":"id","end":""}],
    types: placeholder as Registry['meesho_labels.update_schedule']['types'],
  },
  'meesho_labels.toggle_schedule': {
    methods: ["PATCH"],
    pattern: '/meesho/labels/schedules/:id/toggle',
    tokens: [{"old":"/meesho/labels/schedules/:id/toggle","type":0,"val":"meesho","end":""},{"old":"/meesho/labels/schedules/:id/toggle","type":0,"val":"labels","end":""},{"old":"/meesho/labels/schedules/:id/toggle","type":0,"val":"schedules","end":""},{"old":"/meesho/labels/schedules/:id/toggle","type":1,"val":"id","end":""},{"old":"/meesho/labels/schedules/:id/toggle","type":0,"val":"toggle","end":""}],
    types: placeholder as Registry['meesho_labels.toggle_schedule']['types'],
  },
  'meesho_labels.destroy_schedule': {
    methods: ["DELETE"],
    pattern: '/meesho/labels/schedules/:id',
    tokens: [{"old":"/meesho/labels/schedules/:id","type":0,"val":"meesho","end":""},{"old":"/meesho/labels/schedules/:id","type":0,"val":"labels","end":""},{"old":"/meesho/labels/schedules/:id","type":0,"val":"schedules","end":""},{"old":"/meesho/labels/schedules/:id","type":1,"val":"id","end":""}],
    types: placeholder as Registry['meesho_labels.destroy_schedule']['types'],
  },
